import{L as Ct,r as y,aN as zt,o as Et,u as At,a as It,q as Dt,g as U,aE as Mt,j as e,Q as Qe,c as be,d as Ye,F as Ot,S as oe,m as P,a8 as Tt,h as $t,e as A,ar as Ee,f as Ae,T as Ke,Z as _t,A as ce,i as K,w as Xe,X as Ie,l as De,n as Z,s as de,p as Lt,k as ye,O as he,aO as Me,G as Rt,t as Ft,v as Ht,x as Ze,y as Je,a7 as Pt}from"./index-DUUhvrSX.js";import{l as ve,L as we,a as je}from"./loggingService-CeAdc1EL.js";import{P as Gt}from"./pdfService-BUL7utKB.js";import{Q as qt}from"./QRScanner-DzNVdGvE.js";import{D as et}from"./download-ClPuHaAK.js";import{P as Ut}from"./plus-D6ZbiiJb.js";import{F as Wt}from"./funnel-BuXkD_32.js";import{S as Bt}from"./square-pen-4UXKdaHl.js";import{R as Vt}from"./rotate-ccw-ZS0SJ8zC.js";import{C as Qt}from"./chevron-up-YN0yzbvV.js";import"./jspdf.plugin.autotable-h3Z-y7fq.js";/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Yt=[["path",{d:"m21.64 3.64-1.28-1.28a1.21 1.21 0 0 0-1.72 0L2.36 18.64a1.21 1.21 0 0 0 0 1.72l1.28 1.28a1.2 1.2 0 0 0 1.72 0L21.64 5.36a1.2 1.2 0 0 0 0-1.72",key:"ul74o6"}],["path",{d:"m14 7 3 3",key:"1r5n42"}],["path",{d:"M5 6v4",key:"ilb8ba"}],["path",{d:"M19 14v4",key:"blhpug"}],["path",{d:"M10 2v2",key:"7u0qdc"}],["path",{d:"M7 8H3",key:"zfb6yr"}],["path",{d:"M21 16h-4",key:"1cnmox"}],["path",{d:"M11 3H9",key:"1obp7u"}]],Kt=Ct("wand-sparkles",Yt);function J(h,m,s){let a=s.initialDeps??[],r,i=!0;function c(){var d,f,k;let j;s.key&&((d=s.debug)!=null&&d.call(s))&&(j=Date.now());const w=h();if(!(w.length!==a.length||w.some((S,F)=>a[F]!==S)))return r;a=w;let o;if(s.key&&((f=s.debug)!=null&&f.call(s))&&(o=Date.now()),r=m(...w),s.key&&((k=s.debug)!=null&&k.call(s))){const S=Math.round((Date.now()-j)*100)/100,F=Math.round((Date.now()-o)*100)/100,E=F/16,I=(D,H)=>{for(D=String(D);D.length<H;)D=" "+D;return D};console.info(`%c⏱ ${I(F,5)} /${I(S,5)} ms`,`
            font-size: .6rem;
            font-weight: bold;
            color: hsl(${Math.max(0,Math.min(120-120*E,120))}deg 100% 31%);`,s==null?void 0:s.key)}return s!=null&&s.onChange&&!(i&&s.skipInitialOnChange)&&s.onChange(r),i=!1,r}return c.updateDeps=d=>{a=d},c}function tt(h,m){if(h===void 0)throw new Error("Unexpected undefined");return h}const Xt=(h,m)=>Math.abs(h-m)<1.01,Zt=(h,m,s)=>{let a;return function(...r){h.clearTimeout(a),a=h.setTimeout(()=>m.apply(this,r),s)}},st=h=>{const{offsetWidth:m,offsetHeight:s}=h;return{width:m,height:s}},Jt=h=>h,es=h=>{const m=Math.max(h.startIndex-h.overscan,0),s=Math.min(h.endIndex+h.overscan,h.count-1),a=[];for(let r=m;r<=s;r++)a.push(r);return a},ts=(h,m)=>{const s=h.scrollElement;if(!s)return;const a=h.targetWindow;if(!a)return;const r=c=>{const{width:d,height:f}=c;m({width:Math.round(d),height:Math.round(f)})};if(r(st(s)),!a.ResizeObserver)return()=>{};const i=new a.ResizeObserver(c=>{const d=()=>{const f=c[0];if(f!=null&&f.borderBoxSize){const k=f.borderBoxSize[0];if(k){r({width:k.inlineSize,height:k.blockSize});return}}r(st(s))};h.options.useAnimationFrameWithResizeObserver?requestAnimationFrame(d):d()});return i.observe(s,{box:"border-box"}),()=>{i.unobserve(s)}},at={passive:!0},rt=typeof window>"u"?!0:"onscrollend"in window,ss=(h,m)=>{const s=h.scrollElement;if(!s)return;const a=h.targetWindow;if(!a)return;let r=0;const i=h.options.useScrollendEvent&&rt?()=>{}:Zt(a,()=>{m(r,!1)},h.options.isScrollingResetDelay),c=j=>()=>{const{horizontal:w,isRtl:z}=h.options;r=w?s.scrollLeft*(z&&-1||1):s.scrollTop,i(),m(r,j)},d=c(!0),f=c(!1);s.addEventListener("scroll",d,at);const k=h.options.useScrollendEvent&&rt;return k&&s.addEventListener("scrollend",f,at),()=>{s.removeEventListener("scroll",d),k&&s.removeEventListener("scrollend",f)}},as=(h,m,s)=>{if(m!=null&&m.borderBoxSize){const a=m.borderBoxSize[0];if(a)return Math.round(a[s.options.horizontal?"inlineSize":"blockSize"])}return h[s.options.horizontal?"offsetWidth":"offsetHeight"]},rs=(h,{adjustments:m=0,behavior:s},a)=>{var r,i;const c=h+m;(i=(r=a.scrollElement)==null?void 0:r.scrollTo)==null||i.call(r,{[a.options.horizontal?"left":"top"]:c,behavior:s})};class ns{constructor(m){this.unsubs=[],this.scrollElement=null,this.targetWindow=null,this.isScrolling=!1,this.scrollState=null,this.measurementsCache=[],this.itemSizeCache=new Map,this.laneAssignments=new Map,this.pendingMeasuredCacheIndexes=[],this.prevLanes=void 0,this.lanesChangedFlag=!1,this.lanesSettling=!1,this.scrollRect=null,this.scrollOffset=null,this.scrollDirection=null,this.scrollAdjustments=0,this.elementsCache=new Map,this.now=()=>{var s,a,r;return((r=(a=(s=this.targetWindow)==null?void 0:s.performance)==null?void 0:a.now)==null?void 0:r.call(a))??Date.now()},this.observer=(()=>{let s=null;const a=()=>s||(!this.targetWindow||!this.targetWindow.ResizeObserver?null:s=new this.targetWindow.ResizeObserver(r=>{r.forEach(i=>{const c=()=>{const d=i.target,f=this.indexFromElement(d);if(!d.isConnected){this.observer.unobserve(d);return}this.shouldMeasureDuringScroll(f)&&this.resizeItem(f,this.options.measureElement(d,i,this))};this.options.useAnimationFrameWithResizeObserver?requestAnimationFrame(c):c()})}));return{disconnect:()=>{var r;(r=a())==null||r.disconnect(),s=null},observe:r=>{var i;return(i=a())==null?void 0:i.observe(r,{box:"border-box"})},unobserve:r=>{var i;return(i=a())==null?void 0:i.unobserve(r)}}})(),this.range=null,this.setOptions=s=>{Object.entries(s).forEach(([a,r])=>{typeof r>"u"&&delete s[a]}),this.options={debug:!1,initialOffset:0,overscan:1,paddingStart:0,paddingEnd:0,scrollPaddingStart:0,scrollPaddingEnd:0,horizontal:!1,getItemKey:Jt,rangeExtractor:es,onChange:()=>{},measureElement:as,initialRect:{width:0,height:0},scrollMargin:0,gap:0,indexAttribute:"data-index",initialMeasurementsCache:[],lanes:1,isScrollingResetDelay:150,enabled:!0,isRtl:!1,useScrollendEvent:!1,useAnimationFrameWithResizeObserver:!1,laneAssignmentMode:"estimate",...s}},this.notify=s=>{var a,r;(r=(a=this.options).onChange)==null||r.call(a,this,s)},this.maybeNotify=J(()=>(this.calculateRange(),[this.isScrolling,this.range?this.range.startIndex:null,this.range?this.range.endIndex:null]),s=>{this.notify(s)},{key:!1,debug:()=>this.options.debug,initialDeps:[this.isScrolling,this.range?this.range.startIndex:null,this.range?this.range.endIndex:null]}),this.cleanup=()=>{this.unsubs.filter(Boolean).forEach(s=>s()),this.unsubs=[],this.observer.disconnect(),this.rafId!=null&&this.targetWindow&&(this.targetWindow.cancelAnimationFrame(this.rafId),this.rafId=null),this.scrollState=null,this.scrollElement=null,this.targetWindow=null},this._didMount=()=>()=>{this.cleanup()},this._willUpdate=()=>{var s;const a=this.options.enabled?this.options.getScrollElement():null;if(this.scrollElement!==a){if(this.cleanup(),!a){this.maybeNotify();return}this.scrollElement=a,this.scrollElement&&"ownerDocument"in this.scrollElement?this.targetWindow=this.scrollElement.ownerDocument.defaultView:this.targetWindow=((s=this.scrollElement)==null?void 0:s.window)??null,this.elementsCache.forEach(r=>{this.observer.observe(r)}),this.unsubs.push(this.options.observeElementRect(this,r=>{this.scrollRect=r,this.maybeNotify()})),this.unsubs.push(this.options.observeElementOffset(this,(r,i)=>{this.scrollAdjustments=0,this.scrollDirection=i?this.getScrollOffset()<r?"forward":"backward":null,this.scrollOffset=r,this.isScrolling=i,this.scrollState&&this.scheduleScrollReconcile(),this.maybeNotify()})),this._scrollToOffset(this.getScrollOffset(),{adjustments:void 0,behavior:void 0})}},this.rafId=null,this.getSize=()=>this.options.enabled?(this.scrollRect=this.scrollRect??this.options.initialRect,this.scrollRect[this.options.horizontal?"width":"height"]):(this.scrollRect=null,0),this.getScrollOffset=()=>this.options.enabled?(this.scrollOffset=this.scrollOffset??(typeof this.options.initialOffset=="function"?this.options.initialOffset():this.options.initialOffset),this.scrollOffset):(this.scrollOffset=null,0),this.getFurthestMeasurement=(s,a)=>{const r=new Map,i=new Map;for(let c=a-1;c>=0;c--){const d=s[c];if(r.has(d.lane))continue;const f=i.get(d.lane);if(f==null||d.end>f.end?i.set(d.lane,d):d.end<f.end&&r.set(d.lane,!0),r.size===this.options.lanes)break}return i.size===this.options.lanes?Array.from(i.values()).sort((c,d)=>c.end===d.end?c.index-d.index:c.end-d.end)[0]:void 0},this.getMeasurementOptions=J(()=>[this.options.count,this.options.paddingStart,this.options.scrollMargin,this.options.getItemKey,this.options.enabled,this.options.lanes,this.options.laneAssignmentMode],(s,a,r,i,c,d,f)=>(this.prevLanes!==void 0&&this.prevLanes!==d&&(this.lanesChangedFlag=!0),this.prevLanes=d,this.pendingMeasuredCacheIndexes=[],{count:s,paddingStart:a,scrollMargin:r,getItemKey:i,enabled:c,lanes:d,laneAssignmentMode:f}),{key:!1}),this.getMeasurements=J(()=>[this.getMeasurementOptions(),this.itemSizeCache],({count:s,paddingStart:a,scrollMargin:r,getItemKey:i,enabled:c,lanes:d,laneAssignmentMode:f},k)=>{if(!c)return this.measurementsCache=[],this.itemSizeCache.clear(),this.laneAssignments.clear(),[];if(this.laneAssignments.size>s)for(const o of this.laneAssignments.keys())o>=s&&this.laneAssignments.delete(o);this.lanesChangedFlag&&(this.lanesChangedFlag=!1,this.lanesSettling=!0,this.measurementsCache=[],this.itemSizeCache.clear(),this.laneAssignments.clear(),this.pendingMeasuredCacheIndexes=[]),this.measurementsCache.length===0&&!this.lanesSettling&&(this.measurementsCache=this.options.initialMeasurementsCache,this.measurementsCache.forEach(o=>{this.itemSizeCache.set(o.key,o.size)}));const j=this.lanesSettling?0:this.pendingMeasuredCacheIndexes.length>0?Math.min(...this.pendingMeasuredCacheIndexes):0;this.pendingMeasuredCacheIndexes=[],this.lanesSettling&&this.measurementsCache.length===s&&(this.lanesSettling=!1);const w=this.measurementsCache.slice(0,j),z=new Array(d).fill(void 0);for(let o=0;o<j;o++){const S=w[o];S&&(z[S.lane]=o)}for(let o=j;o<s;o++){const S=i(o),F=this.laneAssignments.get(o);let E,I;const D=f==="estimate"||k.has(S);if(F!==void 0&&this.options.lanes>1){E=F;const M=z[E],W=M!==void 0?w[M]:void 0;I=W?W.end+this.options.gap:a+r}else{const M=this.options.lanes===1?w[o-1]:this.getFurthestMeasurement(w,o);I=M?M.end+this.options.gap:a+r,E=M?M.lane:o%this.options.lanes,this.options.lanes>1&&D&&this.laneAssignments.set(o,E)}const H=k.get(S),te=typeof H=="number"?H:this.options.estimateSize(o),me=I+te;w[o]={index:o,start:I,size:te,end:me,key:S,lane:E},z[E]=o}return this.measurementsCache=w,w},{key:!1,debug:()=>this.options.debug}),this.calculateRange=J(()=>[this.getMeasurements(),this.getSize(),this.getScrollOffset(),this.options.lanes],(s,a,r,i)=>this.range=s.length>0&&a>0?is({measurements:s,outerSize:a,scrollOffset:r,lanes:i}):null,{key:!1,debug:()=>this.options.debug}),this.getVirtualIndexes=J(()=>{let s=null,a=null;const r=this.calculateRange();return r&&(s=r.startIndex,a=r.endIndex),this.maybeNotify.updateDeps([this.isScrolling,s,a]),[this.options.rangeExtractor,this.options.overscan,this.options.count,s,a]},(s,a,r,i,c)=>i===null||c===null?[]:s({startIndex:i,endIndex:c,overscan:a,count:r}),{key:!1,debug:()=>this.options.debug}),this.indexFromElement=s=>{const a=this.options.indexAttribute,r=s.getAttribute(a);return r?parseInt(r,10):(console.warn(`Missing attribute name '${a}={index}' on measured element.`),-1)},this.shouldMeasureDuringScroll=s=>{var a;if(!this.scrollState||this.scrollState.behavior!=="smooth")return!0;const r=this.scrollState.index??((a=this.getVirtualItemForOffset(this.scrollState.lastTargetOffset))==null?void 0:a.index);if(r!==void 0&&this.range){const i=Math.max(this.options.overscan,Math.ceil((this.range.endIndex-this.range.startIndex)/2)),c=Math.max(0,r-i),d=Math.min(this.options.count-1,r+i);return s>=c&&s<=d}return!0},this.measureElement=s=>{if(!s){this.elementsCache.forEach((c,d)=>{c.isConnected||(this.observer.unobserve(c),this.elementsCache.delete(d))});return}const a=this.indexFromElement(s),r=this.options.getItemKey(a),i=this.elementsCache.get(r);i!==s&&(i&&this.observer.unobserve(i),this.observer.observe(s),this.elementsCache.set(r,s)),(!this.isScrolling||this.scrollState)&&this.shouldMeasureDuringScroll(a)&&this.resizeItem(a,this.options.measureElement(s,void 0,this))},this.resizeItem=(s,a)=>{var r;const i=this.measurementsCache[s];if(!i)return;const c=this.itemSizeCache.get(i.key)??i.size,d=a-c;d!==0&&(((r=this.scrollState)==null?void 0:r.behavior)!=="smooth"&&(this.shouldAdjustScrollPositionOnItemSizeChange!==void 0?this.shouldAdjustScrollPositionOnItemSizeChange(i,d,this):i.start<this.getScrollOffset()+this.scrollAdjustments)&&this._scrollToOffset(this.getScrollOffset(),{adjustments:this.scrollAdjustments+=d,behavior:void 0}),this.pendingMeasuredCacheIndexes.push(i.index),this.itemSizeCache=new Map(this.itemSizeCache.set(i.key,a)),this.notify(!1))},this.getVirtualItems=J(()=>[this.getVirtualIndexes(),this.getMeasurements()],(s,a)=>{const r=[];for(let i=0,c=s.length;i<c;i++){const d=s[i],f=a[d];r.push(f)}return r},{key:!1,debug:()=>this.options.debug}),this.getVirtualItemForOffset=s=>{const a=this.getMeasurements();if(a.length!==0)return tt(a[it(0,a.length-1,r=>tt(a[r]).start,s)])},this.getMaxScrollOffset=()=>{if(!this.scrollElement)return 0;if("scrollHeight"in this.scrollElement)return this.options.horizontal?this.scrollElement.scrollWidth-this.scrollElement.clientWidth:this.scrollElement.scrollHeight-this.scrollElement.clientHeight;{const s=this.scrollElement.document.documentElement;return this.options.horizontal?s.scrollWidth-this.scrollElement.innerWidth:s.scrollHeight-this.scrollElement.innerHeight}},this.getOffsetForAlignment=(s,a,r=0)=>{if(!this.scrollElement)return 0;const i=this.getSize(),c=this.getScrollOffset();a==="auto"&&(a=s>=c+i?"end":"start"),a==="center"?s+=(r-i)/2:a==="end"&&(s-=i);const d=this.getMaxScrollOffset();return Math.max(Math.min(d,s),0)},this.getOffsetForIndex=(s,a="auto")=>{s=Math.max(0,Math.min(s,this.options.count-1));const r=this.getSize(),i=this.getScrollOffset(),c=this.measurementsCache[s];if(!c)return;if(a==="auto")if(c.end>=i+r-this.options.scrollPaddingEnd)a="end";else if(c.start<=i+this.options.scrollPaddingStart)a="start";else return[i,a];if(a==="end"&&s===this.options.count-1)return[this.getMaxScrollOffset(),a];const d=a==="end"?c.end+this.options.scrollPaddingEnd:c.start-this.options.scrollPaddingStart;return[this.getOffsetForAlignment(d,a,c.size),a]},this.scrollToOffset=(s,{align:a="start",behavior:r="auto"}={})=>{const i=this.getOffsetForAlignment(s,a),c=this.now();this.scrollState={index:null,align:a,behavior:r,startedAt:c,lastTargetOffset:i,stableFrames:0},this._scrollToOffset(i,{adjustments:void 0,behavior:r}),this.scheduleScrollReconcile()},this.scrollToIndex=(s,{align:a="auto",behavior:r="auto"}={})=>{s=Math.max(0,Math.min(s,this.options.count-1));const i=this.getOffsetForIndex(s,a);if(!i)return;const[c,d]=i,f=this.now();this.scrollState={index:s,align:d,behavior:r,startedAt:f,lastTargetOffset:c,stableFrames:0},this._scrollToOffset(c,{adjustments:void 0,behavior:r}),this.scheduleScrollReconcile()},this.scrollBy=(s,{behavior:a="auto"}={})=>{const r=this.getScrollOffset()+s,i=this.now();this.scrollState={index:null,align:"start",behavior:a,startedAt:i,lastTargetOffset:r,stableFrames:0},this._scrollToOffset(r,{adjustments:void 0,behavior:a}),this.scheduleScrollReconcile()},this.getTotalSize=()=>{var s;const a=this.getMeasurements();let r;if(a.length===0)r=this.options.paddingStart;else if(this.options.lanes===1)r=((s=a[a.length-1])==null?void 0:s.end)??0;else{const i=Array(this.options.lanes).fill(null);let c=a.length-1;for(;c>=0&&i.some(d=>d===null);){const d=a[c];i[d.lane]===null&&(i[d.lane]=d.end),c--}r=Math.max(...i.filter(d=>d!==null))}return Math.max(r-this.options.scrollMargin+this.options.paddingEnd,0)},this._scrollToOffset=(s,{adjustments:a,behavior:r})=>{this.options.scrollToFn(s,{behavior:r,adjustments:a},this)},this.measure=()=>{this.itemSizeCache=new Map,this.laneAssignments=new Map,this.notify(!1)},this.setOptions(m)}scheduleScrollReconcile(){if(!this.targetWindow){this.scrollState=null;return}this.rafId==null&&(this.rafId=this.targetWindow.requestAnimationFrame(()=>{this.rafId=null,this.reconcileScroll()}))}reconcileScroll(){if(!this.scrollState||!this.scrollElement)return;if(this.now()-this.scrollState.startedAt>5e3){this.scrollState=null;return}const a=this.scrollState.index!=null?this.getOffsetForIndex(this.scrollState.index,this.scrollState.align):void 0,r=a?a[0]:this.scrollState.lastTargetOffset,i=1,c=r!==this.scrollState.lastTargetOffset;if(!c&&Xt(r,this.getScrollOffset())){if(this.scrollState.stableFrames++,this.scrollState.stableFrames>=i){this.scrollState=null;return}}else this.scrollState.stableFrames=0,c&&(this.scrollState.lastTargetOffset=r,this.scrollState.behavior="auto",this._scrollToOffset(r,{adjustments:void 0,behavior:"auto"}));this.scheduleScrollReconcile()}}const it=(h,m,s,a)=>{for(;h<=m;){const r=(h+m)/2|0,i=s(r);if(i<a)h=r+1;else if(i>a)m=r-1;else return r}return h>0?h-1:0};function is({measurements:h,outerSize:m,scrollOffset:s,lanes:a}){const r=h.length-1,i=f=>h[f].start;if(h.length<=a)return{startIndex:0,endIndex:r};let c=it(0,r,i,s),d=c;if(a===1)for(;d<r&&h[d].end<s+m;)d++;else if(a>1){const f=Array(a).fill(0);for(;d<r&&f.some(j=>j<s+m);){const j=h[d];f[j.lane]=j.end,d++}const k=Array(a).fill(s+m);for(;c>=0&&k.some(j=>j>=s);){const j=h[c];k[j.lane]=j.start,c--}c=Math.max(0,c-c%a),d=Math.min(r,d+(a-1-d%a))}return{startIndex:c,endIndex:d}}const nt=typeof document<"u"?y.useLayoutEffect:y.useEffect;function ls({useFlushSync:h=!0,...m}){const s=y.useReducer(()=>({}),{})[1],a={...m,onChange:(i,c)=>{var d;h&&c?zt.flushSync(s):s(),(d=m.onChange)==null||d.call(m,i,c)}},[r]=y.useState(()=>new ns(a));return r.setOptions(a),nt(()=>r._didMount(),[]),nt(()=>r._willUpdate()),r}function os(h){return ls({observeElementRect:ts,observeElementOffset:ss,scrollToFn:rs,...h})}function cs(h,m,s=[]){const[a,r]=y.useState([]),[i,c]=y.useState(!0),[d,f]=y.useState(null),[k,j]=[!1,z=>z()],w=y.useRef(null);return y.useEffect(()=>{c(!0);let z=!0;return w.current=Et(h,o=>{z&&j(()=>{const S=o.docs.map(m);r(S),c(!1)})},o=>{z&&(console.error("Firestore onSnapshot error:",o),f(o),c(!1))}),()=>{z=!1,w.current&&w.current()}},s),{data:a,loading:i,error:d}}const ee={GHS01:"/ghs/GHS01.png",GHS02:"/ghs/GHS02.png",GHS03:"/ghs/GHS03.png",GHS04:"/ghs/GHS04.png",GHS05:"/ghs/GHS05.png",GHS06:"/ghs/GHS06.png",GHS07:"/ghs/GHS07.png",GHS08:"/ghs/GHS08.png",GHS09:"/ghs/GHS09.png"},pe={GHS01:"متفجرات",GHS02:"قابل للاشتعال",GHS03:"مؤكسد",GHS04:"غاز تحت الضغط",GHS05:"أكال / مسبب للتآكل",GHS06:"سمية حادة (قاتل)",GHS07:"تهيج / تحسس / خطر",GHS08:"خطر صحي جسيم",GHS09:"خطر بيئي"};function ws({isNested:h=!1}){var Ge,qe,Ue,We,Be;const{schoolId:m,schoolName:s,directorate:a}=At(),[r]=It(),[i,c]=y.useState([]),[d,f]=y.useState(!0),[k,j]=y.useState(""),[w,z]=y.useState(r.get("filter")==="low"),[o,S]=y.useState(null),[F,E]=y.useState(!1),[I,D]=y.useState(null),H=y.useRef(null),[te,me]=y.useState(!1),[M,W]=y.useState(!1),[Oe,Te]=y.useState(!1),[lt,ue]=y.useState(!1),[$e,_e]=y.useState({current:0,total:0}),[T,se]=y.useState([]),[v,Le]=y.useState(null),[ot,ae]=y.useState(!1),[O,ct]=y.useState(null),[dt,Ne]=y.useState(!1),ke=t=>{if(!t)return"غير محدد";if(!t.includes("-"))return t;const[l,n,p]=t.split("-");return!l||!n||!p?t:`${p}/${n}/${l}`},[g,C]=y.useState({nameEn:"",nameAr:"",formula:"",casNumber:"",storageTemp:"",unit:"g",quantity:0,state:"solid",hazardClass:"safe",ghs:[],shelf:"",expiryDate:"",notes:""}),{data:B,loading:Re}=cs(Dt(U(m,"chemicals")),t=>({id:t.id,...t.data()}),[m]);y.useEffect(()=>{if(!Re){c(B),f(!1);const t=r.get("id");if(t){let l=t;t.startsWith("APP_ID_")&&(l=t.split("_").slice(2,-1).join("_")),j(l);const n=B.find(p=>p.id===t||p.id===l);n?S(n):B.length>0&&!o&&S(B[0])}else B.length>0&&!o&&S(B[0])}},[B,Re,r]);const ht=async t=>{t.preventDefault();try{if(I){const{id:l}=I;await De(Z(U(m,"chemicals"),l),{...g,updatedAt:de()}),await ve(m,we.UPDATE,je.CHEMICALS,`تعديل بيانات المادة: ${g.nameAr}`,l)}else{const l=await Lt(U(m,"chemicals"),{...g,createdAt:de()});await ve(m,we.CREATE,je.CHEMICALS,`إضافة مادة جديدة: ${g.nameAr}`,l.id)}E(!1),D(null),C({nameEn:"",nameAr:"",formula:"",casNumber:"",storageTemp:"",unit:"g",quantity:0,state:"solid",hazardClass:"safe",ghs:[],shelf:"",expiryDate:"",notes:""})}catch(l){ye(l,I?he.UPDATE:he.CREATE,"chemicals")}},pt=async()=>{const t=g.nameEn||g.nameAr;if(!t){alert("يرجى إدخال اسم المادة أولاً (بالعربية أو الإنجليزية)");return}W(!0);try{const l=await Me(t);if(l){let n="";if(l.expiryYears>0){const p=new Date;p.setFullYear(p.getFullYear()+l.expiryYears),n=p.toISOString().split("T")[0]}C(p=>({...p,nameEn:l.nameEn||p.nameEn,nameAr:l.nameAr||p.nameAr,formula:l.formula||p.formula,casNumber:l.casNumber||p.casNumber,storageTemp:l.storageTemp||p.storageTemp,hazardClass:l.hazardClass||p.hazardClass,ghs:l.ghs||p.ghs,expiryDate:n||p.expiryDate,notes:l.notes||p.notes}))}else alert("لم نتمكن من الحصول على معلومات دقيقة لهذه المادة. يرجى إدخالها يدوياً.")}catch(l){console.error("Smart fill error:",l),alert("حدث خطأ أثناء محاولة الحصول على المعلومات الذكية.")}finally{W(!1)}},Fe=async t=>{const l=t||o;if(l){W(!0);try{const n=await Me(l.nameEn||l.nameAr);n?(Le(n),t&&S(t),ae(!0)):alert("لم نتمكن من الحصول على اقتراحات تحديث لهذه المادة.")}catch(n){console.error("Smart update request error:",n),alert("حدث خطأ أثناء طلب التحديث الذكي.")}finally{W(!1)}}},mt=async()=>{if(!(!o||!v))try{let t=o.expiryDate;if(v.expiryYears>0){const l=new Date;l.setFullYear(l.getFullYear()+v.expiryYears),t=l.toISOString().split("T")[0]}await De(Z(U(m,"chemicals"),o.id),{nameEn:v.nameEn,nameAr:v.nameAr,formula:v.formula,casNumber:v.casNumber,storageTemp:v.storageTemp,hazardClass:v.hazardClass,ghs:v.ghs,expiryDate:t,notes:v.notes,updatedAt:de()}),ae(!1),Le(null),alert("تم تحديث معلومات المادة بنجاح!")}catch(t){ye(t,he.UPDATE,`chemicals/${o.id}`)}},ut=async()=>{if(ue(!1),!await Rt()){alert("يرجى اختيار مفتاح API الخاص بك لاستخدام ميزة التحديث الذكي.");return}Te(!0),_e({current:0,total:i.length});let l=0,n=0;for(let p=0;p<i.length;p++){const x=i[p];_e({current:p+1,total:i.length});try{const u=await Me(x.nameEn||x.nameAr);if(u){let b=x.expiryDate;if(u.expiryYears>0){const L=new Date;L.setFullYear(L.getFullYear()+u.expiryYears),b=L.toISOString().split("T")[0]}await De(Z(U(m,"chemicals"),x.id),{nameEn:u.nameEn||x.nameEn,nameAr:u.nameAr||x.nameAr,formula:u.formula||x.formula,casNumber:u.casNumber||x.casNumber,storageTemp:u.storageTemp||x.storageTemp,hazardClass:u.hazardClass||x.hazardClass,ghs:u.ghs||x.ghs,expiryDate:b||x.expiryDate,notes:u.notes||x.notes,updatedAt:de()}),l++}else n++}catch(u){console.error(`Error updating chemical ${x.nameEn}:`,u),n++;const b=(u==null?void 0:u.message)||String(u);if(b.includes("quota")||b.includes("RESOURCE_EXHAUSTED")){alert("تم إيقاف التحديث التلقائي بسبب تجاوز حصة الاستخدام المسموح بها (Quota Exceeded). يرجى المحاولة لاحقاً أو التحقق من حساب Gemini API الخاص بك.");break}}await new Promise(u=>setTimeout(u,5e3))}Te(!1),alert(`اكتمل التحديث الذكي!
تم تحديث: ${l} مادة بنجاح
فشل: ${n} مادة`)},xt=async(t,l)=>{try{await Ft(Z(U(m,"chemicals"),t)),await ve(m,we.DELETE,je.CHEMICALS,`حذف المادة: ${l}`,t),(o==null?void 0:o.id)===t&&S(i.find(n=>n.id!==t)||null)}catch(n){ye(n,he.DELETE,`chemicals/${t}`)}},ft=()=>{const t=window.open("","_blank");if(!t){alert("يرجى السماح بالنوافذ المنبثقة لطباعة القائمة");return}const l=Q.filter(b=>b.ghs&&b.ghs.length>0||b.hazardClass==="danger").length,p=new Date().toLocaleDateString("ar-DZ",{day:"2-digit",month:"2-digit",year:"numeric"}),x="2025/2026",u=Q.map((b,L)=>{const re=b.ghs&&b.ghs.length>0||b.hazardClass==="danger",ne=(b.ghs||[]).map(G=>`<div class="ghs-pic"><img src="${ee[G]}" alt="${G}" /></div>`).join("");return`
        <tr class="${re?"hazardous-row":""}">
          ...
          <td><div class="ghs-container">${ne}</div></td>
    ...
    `),t.document.close()},gt=async()=>{const t=["#","الاسم العلمي","الاسم العربي","الصيغة","الكمية","الرف","تاريخ الصلاحية"],l=$.map((n,p)=>[p+1,n.nameEn||"",n.nameAr||"",n.formula||"",`${n.quantity} ${n.unit}`,n.shelf||"",ke(n.expiryDate)]);await Gt.generateTablePDF("تقرير جرد المواد الكيميائية",t,l,`chemicals_inventory_${new Date().toISOString().split("T")[0]}.pdf`)},bt=()=>{const t=K.json_to_sheet($.map(n=>({"الاسم (EN)":n.nameEn,"الاسم (AR)":n.nameAr,الصيغة:n.formula,"رقم CAS":n.casNumber,الكمية:n.quantity,الوحدة:n.unit,الحالة:n.state,الخطورة:n.hazardClass,الرف:n.shelf,"تاريخ الصلاحية":n.expiryDate,ملاحظات:n.notes}))),l=K.book_new();K.book_append_sheet(l,t,"Inventory"),Xe(l,`chemical_inventory_${new Date().toISOString().split("T")[0]}.xlsx`)},yt=async t=>{var p;const l=(p=t.target.files)==null?void 0:p[0];if(!l)return;me(!0);const n=new FileReader;n.onload=async x=>{var u;try{const b=(u=x.target)==null?void 0:u.result,L=Ht(b,{type:"binary",cellDates:!0}),re=L.SheetNames[0],ne=L.Sheets[re],G=K.sheet_to_json(ne),xe=N=>{if(!N)return"";if(N instanceof Date)return N.toISOString().split("T")[0];const X=new Date(N);return isNaN(X.getTime())?String(N).trim():X.toISOString().split("T")[0]},R=(N,X)=>{const Ce=Object.keys(N);for(const ie of X){const le=Ce.find(q=>q.toLowerCase().trim()===ie.toLowerCase().trim());if(le)return N[le]}},Ve=Ze(Je);G.forEach(N=>{const X=R(N,["PRODUIT CHIMIQUE","Name","nameEn","Product","Chemical"])||"Unnamed Chemical",Ce=R(N,["الاسم العربي","الاسم","Arabic Name","nameAr","Arabic"])||"",ie=R(N,["الكمية","Quantity","quantity","Qty","Amount"]),le=typeof ie=="number"?ie:parseFloat(String(ie||"0").replace(/[^0-9.]/g,""));let q=String(R(N,["الحالة","State","state","Status"])||"solid").trim(),fe="solid";q==="صلب"||q.toLowerCase()==="solid"?fe="solid":q==="سائل"||q.toLowerCase()==="liquid"?fe="liquid":(q==="غاز"||q.toLowerCase()==="gas")&&(fe="gas");let ge=String(R(N,["الخطورة","Hazard","hazardClass","Danger"])||"safe").trim(),ze="safe";ge==="خطر"||ge.toLowerCase()==="danger"?ze="danger":(ge==="آمن"||ge.toLowerCase()==="safe")&&(ze="safe");const kt=Z(U(m,"chemicals"));Ve.set(kt,{nameEn:String(X).trim(),nameAr:String(Ce).trim(),formula:R(N,["الصيغة","Formula","formula"])||"",unit:R(N,["الوحدة","Unit","unit"])||"g",quantity:isNaN(le)?0:le,state:fe,hazardClass:ze,ghs:Array.isArray(N.GHS)?N.GHS:N.GHS?String(N.GHS).split(",").map(St=>St.trim()):[],shelf:R(N,["الرف","Shelf","shelf"])||"",expiryDate:xe(R(N,["الصلاحية","Expiry","تاريخ الانتهاء","expiryDate"])),notes:R(N,["ملاحظات","Notes","notes"])||"",createdAt:de()})}),await Ve.commit(),alert(`تم استيراد ${G.length} مادة بنجاح!`)}catch(b){console.error("Error importing XLS:",b),alert("حدث خطأ أثناء استيراد الملف. يرجى التأكد من صيغة الملف.")}finally{me(!1),H.current&&(H.current.value="")}},n.readAsBinaryString(l)},Se=t=>{const l=window.open("","_blank");if(!l){alert("يرجى السماح بالنوافذ المنبثقة لطباعة البطاقات");return}const n=new Date,p="2025/2026",x=t.map((u,b)=>{var G,xe;const L=u.state==="solid"?"صلب":u.state==="liquid"?"سائل":"غاز",re=u.hazardClass==="danger"?(G=u.ghs)!=null&&G[0]?pe[u.ghs[0]]:"خطر":"آمن",ne=(xe=u.ghs)!=null&&xe[0]?"☠️":"—";return`
        <div class="pcard">
            ...
            <table class="ic-tbl">
              ...
              <tbody>
                <tr class="initial-stock">
                  <td>${n.toLocaleDateString("en-GB")}</td>
                  <td>-</td><td>-</td>
              ...
              <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-top: 10px;">
                ${(t.ghs||[]).map(n=>`
                  <div style="display: flex; flex-direction: column; align-items: center; border: 1px solid #ccc; padding: 5px; border-radius: 8px; width: 70px; background: #fff;">
                    <img src="${ee[n]}" style="width: 40px; height: 40px;" />
                    <span style="font-size: 9px; margin-top: 4px; text-align: center; font-weight: bold;">${pe[n]||n}</span>
                  </div>
                `).join("")}
              </div>
            </div>
